        ...
        <div className="w-full max-w-full px-3 lg:px-6">
          ...
          >
            ...
            <g id="Layer_1" data-name="Layer 1">
              <g>
                <path className="cls-6 letter" d="M13.38,857.2V15.75h164.07v841.45H13.38Z" />
                <path
                  className="cls-5 letter"
                  d="M267.24,435.35c0-241.86,179.99-419.6,412.85-419.6s415.1,177.74,415.1,419.6-181.11,421.85-415.1,421.85-412.85-179.99-412.85-421.85ZM918.58,435.35c0-148.49-89.99-266.61-238.49-266.61s-237.36,118.12-237.36,266.61,89.99,268.86,237.36,268.86,238.49-120.37,238.49-268.86Z"
                />
                <path
                  className="cls-4 letter"
                  d="M1122.05,857.2v-140.63l430.1-547.29h-428.93V15.75h648.08v142.97l-432.44,544.95h446.51v153.52h-663.31Z"
                />
                <path
                  className="cls-3 letter"
                  d="M2004.45,863.06c-64.45,0-112.51-44.53-112.51-106.65s46.88-107.82,112.51-107.82,112.51,45.71,112.51,107.82-48.05,106.65-112.51,106.65ZM1942.34,604.06L1901.32,15.75h206.26l-42.19,588.31h-123.05Z"
                />
                <path
                  className="cls-1 letter"
                  d="M2386.43,270.06v587.14h-162.9V15.75h192.2l366.81,557.84V15.75h164.07v841.45h-174.62l-385.57-587.14Z"
                />
                <path
                  className="cls-2 letter"
                  d="M3053.2,857.2V15.75h329.31c212.12,0,335.17,98.44,335.17,273.06,0,113.68-70.32,203.92-189.86,243.76l216.81,324.63h-212.12l-189.85-297.67h-111.34v297.67h-178.13ZM3231.33,413.04h142.98c107.82,0,165.24-42.19,165.24-124.23s-57.42-125.4-165.24-125.4h-142.98v249.62Z"
                />
              </g>
            </g>
          </svg>
